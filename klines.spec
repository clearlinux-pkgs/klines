...
Version  : 24.05.0
Release  : 66
URL      : https://download.kde.org/stable/release-service/24.05.0/src/klines-24.05.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/klines-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/klines-24.05.0.tar.xz.sig
...
%setup -q -n klines-24.05.0
cd %{_builddir}/klines-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716523946
mkdir -p clr-build
pushd clr-build
