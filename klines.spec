...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/klines-22.08.0.tar.xz
...
%prep
%setup -q -n klines-22.08.0
cd %{_builddir}/klines-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661545948
mkdir -p clr-build
pushd clr-build
