...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/klines-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/klines-24.05.2.tar.xz.sig
...
%setup -q -n klines-24.05.2
cd %{_builddir}/klines-24.05.2
pushd ..
cp -a klines-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720559554
mkdir -p clr-build
pushd clr-build
